...
# FRIENDLYWRT_PATCHS+=(device/friendlyelec/rk3399/patches/0001-optimize-for-rk3399.patch)
...
TARGET_SD_RAW_FILENAME=friendlywrt_21.02_$(date +%Y%m%d)_rk3399_arm64_sd.img
TARGET_EFLASHER_RAW_FILENAME=friendlywrt_21.02_$(date +%Y%m%d)_rk3399_arm64_eflasher.img
